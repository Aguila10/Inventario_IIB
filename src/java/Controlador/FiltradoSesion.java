...
public class FiltradoSesion implements Filter {
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("FiltradoSesion:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("FiltradoSesion()");
        }
        StringBuffer sb = new StringBuffer("FiltradoSesion(");
